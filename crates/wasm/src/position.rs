...
pub struct WASMPosition(pub (crate) Position);
...
impl WASMPosition {
    ...
    pub fn new() -> Result<WASMPosition, JsValue> {
        Ok(WASMPosition(Position::new()))
    }
    ...
    pub fn from_moves(moves: &str) -> Result<WASMPosition, JsValue> {
    ...
    #[wasm_bindgen(js_name=fromBoardString)]
    pub fn from_board_string(board_string: &str) -> Result<WASMPosition, JsValue> {
    ...
    #[wasm_bindgen(js_name=isPlayable)]
    ...
    #[wasm_bindgen(js_name=isWinningMove)]
    ...
    #[wasm_bindgen(js_name=canWinNext)]
    ...
    #[wasm_bindgen(js_name = possibleNonLosingMoves)]
    ...
    #[wasm_bindgen(js_name = isWonPosition)]
    ...
    #[wasm_bindgen(js_name=columnMask)]
